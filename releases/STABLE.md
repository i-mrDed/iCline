...
| ฟิลด์ | ค่า |
|-------|-----|
| **Stable version** | `0.1.15` |
| **Released** | 2026-06-22 |
| **GitHub** | https://github.com/i-mrDedchai/iCline/releases/tag/v0.1.15 |
...
2. GitHub Release `v0.1.15` **ไม่มี**ป้าย Pre-release
3. Marketplace แสดง `0.1.15` (หรือสูงกว่า)
4. หน้า repo README แสดงเวอร์ชันตรงกับ `package.json`
5. มีบันทึกอนุมัติใน `releases/approvals/` (ถ้าข้าม smoke checklist)

## สรุปการเปลี่ยนแปลงหลัก (0.1.15)

- ปรับข้อความติดตั้ง — **ไม่ต้องมี Cline official** (standalone)
- เพิ่ม FAQ บน README / Marketplace Details (EN + TH)
- แก้ Settings → About ให้สอดคล้อง
